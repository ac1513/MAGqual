...
print(" MAG IDs")
print("-" * 12)
print("High Qual: ", *high_qual_clusters, sep=", ", end = "")
print("Near Comp: ", *near_comp_clusters, sep=", ", end = "")
print("Med Qual: ", *med_qual_clusters, sep=", ", end = "")
print("Low Qual: ", *low_qual_clusters, sep=", ", end = "")
print("Failed: ", *NA, sep=", ", end = "" )
