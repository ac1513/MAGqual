...
print(" MAG IDs")
print("-" * 12)
print("High Qual: ", (*high_qual_clusters, sep=", ").strip("\n))
print("Near Comp: ", *near_comp_clusters.strip("\n"), sep=", ")
print("Med Qual: ", *med_qual_clusters.strip("\n"), sep=", ")
print("Low Qual: ", *low_qual_clusters.strip("\n"), sep=", ")
print("Failed: ", *NA.strip("\n"), sep=", ")
